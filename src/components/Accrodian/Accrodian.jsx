                    ...
                    >
                        ...
                        <h3 id="accordion-flush-heading-1">
                            ...
                            >
                                ...
                                <svg
                                    data-accordion-icon=""
                                    className={`w-6 h-6 shrink-0 transform ${openIndex === 3 ? 'rotate-180' : ''}`}
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                            ...
                            <div id="accordion-flush-body-1" aria-labelledby="accordion-flush-heading-1">
                                <div className="py-5 border-b border-gray-200">
                                    ...
                                    <ul className='text-purple-700'>
                                        <li><a href='#'>Landwind Pro</a> </li>
                                        <li><a href='#'>Tailwind UI</a></li>
                                    </ul>
                                </div>
                            </div>
                        )}
                        <h3 id="accordion-flush-heading-1">
                            ...
                            >
                                ...
                                <svg
                                    data-accordion-icon=""
                                    className={`w-6 h-6 shrink-0 transform ${openIndex === 4 ? 'rotate-180' : ''}`}
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
