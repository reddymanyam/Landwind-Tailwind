...
const Quoate = () => {
    return (
        <>
            <div className='text-center mx-3 text-xl md:text-xl lg:py-20 lg:px-80 '>
                ...
                <h1 className='md:text-2xl font-semibold text-center'>"Landwind is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</h1>
